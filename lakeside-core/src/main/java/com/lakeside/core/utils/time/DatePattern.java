...
public enum DatePattern {
	...
	Pattern_6("yyyy年MM月dd日HH:mm","\\d{4}年\\d{2}月\\d{2}日 ?\\d{2}:\\d{2}"),
	Pattern_7("dd-MM-yyyy,hh:mm aa","\\d{2}-\\d{2}-\\d{4}, ?\\d{2}:\\d{2} [A|P]M"),
	Pattern_8("MMMMM dd,yyyy HH:mm","[A-Za-z]{3} \\d{1,2}, ?\\d{4} \\d{2}:\\d{2}"),
	Pattern_9("yyyy-MM-dd","\\d{4}-\\d{2}-\\d{2}"),
	Pattern_10("yyyy年MM月dd日","\\d{4}年\\d{2}月\\d{2}日"),
	Pattern_11("yyyy/MM/dd","\\d{4}/\\d{2}/\\d{2}"),
	Pattern_12("dd MMMMM yyyy","\\d{1,2} [A-Za-z]+ \\d{4}"),
