...
/**
 * A implementation that is able to resolve a
...
public class PathMatchingResourcePatternResolver{
	...
	public Resource[] getResources(String locationPatterns) throws IOException {
        ...
        String[] locations = StringUtils.tokenizeToStringArray(locationPatterns, ",");
        ...
        for(String locationPattern:locations){
            if (locationPattern.startsWith(CLASSPATH_ALL_URL_PREFIX)) {
                ...
                if (getPathMatcher().isPattern(locationPattern.substring(CLASSPATH_ALL_URL_PREFIX.length()))) {
                    ...
                    results.addAll(Arrays.asList(findPathMatchingResources(locationPattern)));
                }
                else {
                    // all class path resources with the given name
                    results.addAll(Arrays.asList(findAllClassPathResources(locationPattern.substring(CLASSPATH_ALL_URL_PREFIX.length()))));
                }
            }
            else {
                ...
                if (getPathMatcher().isPattern(locationPattern.substring(prefixEnd))) {
                    ...
                    results.addAll(Arrays.asList( getResourceLoader().getResource(locationPattern)));
                }
            }
        }
	 ...
	 * @throws java.io.IOException in case of resolution failure
	 */
    ...
    private Resource[] toArray(List<Resource> resources){
        Resource[] arrs = new Resource[resources.size()];
        return resources.toArray(arrs);
    }
}
