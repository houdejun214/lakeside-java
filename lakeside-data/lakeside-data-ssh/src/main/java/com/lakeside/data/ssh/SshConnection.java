...
public class SshConnection {
    ...
    protected final Logger log = LoggerFactory.getLogger(SshConnection.class);
    String host;
    int port = 22;
    String username;
    String password;
    ...
    public void executeTask(SshTask sshTask) throws SshException {
        ...
        log.debug("Beginning SshTask of " + sshTask.toString());

        sshTask.execute(this.sshSession);

        totalTime = (System.currentTimeMillis() - startTime) / 1000;
        log.debug("Completed SshTask of " + sshTask.toString() + " in "
                + totalTime + " seconds.");
    }
    ...
    /**
     * @param host The host a file is being copied to.
     * @throws IllegalStateException If connect() was called once successfully. connect() and any setter
    ...
    /**
     * @param password The password that will be used in ssh authentication.
     * @throws IllegalStateException If connect() was called once successfully. connect() and any setter
     *                               method can't be called after successfully connecting without
     *                               first disconnecting.
     */
    ...
    /**
     * @param port Sets the ssh port. Default is 22.
     * @throws IllegalStateException If connect() was called once successfully. connect() and any setter
     *                               method can't be called after successfully connecting without
     *                               first disconnecting.
     */
    ...
    /**
     * @param username The username that will be used in ssh authentication.
     * @throws IllegalStateException If connect() was called once successfully. connect() and any setter
     *                               method can't be called after successfully connecting without
     *                               first disconnecting.
     */
