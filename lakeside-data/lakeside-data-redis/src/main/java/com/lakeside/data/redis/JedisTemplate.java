...
public class JedisTemplate {
	...
	public String getSet(final String key,final String val){
		return execute(new JedisAction<String>() {
			@Override
			public String action(Jedis jedis) {
	...
	public Boolean hset(final String key,final String field,final String val){
		return execute(new JedisAction<Boolean>() {
			@Override
			public Boolean action(Jedis jedis) {
				return jedis.hset(key, field,val)==1?true:false;
			}
		});
	}
	...
	// ////////////// 关于Set //////////////////////////////////
	public void sadd(final String key,final String... val){
		 execute(new JedisActionNoResult() {
			@Override
			public void action(Jedis jedis) {
				jedis.sadd(key, val);
	...
	public boolean sremove(final String key,final String val){
		return execute(new JedisAction<Boolean>() {
			@Override
			public Boolean action(Jedis jedis) {
				return jedis.srem(key, val) == 1 ? true : false;
			}
		});
	}
